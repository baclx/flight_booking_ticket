...
public interface NguoiDatRepository extends JpaRepository<NguoiDat, Long> {
    ...
    @Query("select new com.example.finalproject.dto.TicketOrderedDto(nd.sdt, nd.diaChi, nd.hoTen, u.username, u.email, vmb.diemKhoiHanh, vmb.diemKetThuc, nd.soNgLon, nd.soTreEm, " +
